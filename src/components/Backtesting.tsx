    ...
    return (
        <div style={{ padding: '1.5rem 2rem', maxWidth: '1280px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {loadingHistory ? (
                ...
                <div style={{ ...cardStyle, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', padding: '4rem', textAlign: 'center' }}>
                    <TrendingDown size={40} style={{ color: 'var(--text-muted)' }} />
                    <div>
                        <h3 style={{ fontSize: '1.125rem', fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 0.5rem 0' }}>Insufficient Data</h3>
                        <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', margin: 0 }}>
                            Not enough historical data for {selectedSymbol}. Needs at least 50 trading days.
                        </p>
                    </div>
                </div>
            ) : (
