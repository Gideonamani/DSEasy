...
const toStockData = (raw: RawStockDoc, symbol: string): StockData => {
  ...
  return {
    ...
    highLowSpread: raw.highLowSpread ?? 0,
    bidOfferRatio: raw.bidOfferRatio ?? 0,
    turnoverPctDaily: raw.turnoverPercent ?? 0,
    turnoverMcapRatio: raw.turnoverPerMcap ?? 0,
    turnoverMcap: raw.turnoverPerMcap ?? 0,
    volPerDeal: raw.volPerDeal ?? 0,
    turnoverPerDeal: raw.turnoverPerDeal ?? 0,
    changePerVol: raw.changePerVol ?? 0,
